...
func helpSections() []helpSection {
	return []helpSection{
		{"file view", keys.file, []helpEntry{
			...
			{acts("note", "note-delete"), "", "note on the cursor line; on a note: edit yours / reply to the agent's · delete the note (ctrl+s saves, esc cancels)"},
			...
			{acts("down", "up", "top", "bottom"), "", "move the line cursor (the view follows); half pages with the half-down / half-up keys"},
